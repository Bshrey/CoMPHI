...
#Ramesh from keras.optimizers import Adam
...
def dna_pro_model(INIT_LR,EPOCHS,shape0,shape1,shape2,shape3,shape4):
    ...
    #preds = Dense(1, activation='relu',name='Dense2')(dt)
